...
<div class=legend>node size = degree · red edge = AMBIGUOUS · amber = INFERRED · gray = EXTRACTED</div>
...
for(const n of nodes){const r=4+Math.min(n.d,12)*1.6;cx.fillStyle=n.d>=8?'#7c9cff':'#9aa4b2';cx.beginPath();cx.arc(n.x,n.y,r,0,7);cx.fill();if(n.d>=6){cx.fillStyle='#cfd6e4';cx.fillText(n.id.split('/').pop(),n.x+r+2,n.y+3);}}}
// tiny force sim
